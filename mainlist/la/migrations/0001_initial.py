# Generated by Django 4.0.8 on 2022-10-24 09:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('in_group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='la.listgroup')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_added', models.DateField(auto_now_add=True)),
                ('for_group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='la.listgroup')),
            ],
            options={
                'ordering': ['name'],
        ...
        migrations.AddField(
            model_name='category',
            name='in_group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='la.listgroup'),
        ),
    ]
